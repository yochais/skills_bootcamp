...
Developed by Cayce Hook, with thanks to Anna Khazenzon and previous authors of R tutorial materials, including Paul Thibodeau, Mike Frank, Benoit Monin, Ewart Thomas, Michael Waskom and Steph Gagnon, Dan Birman, Natalia Velez, Kara Weisman, Andrew Lampinen, Joshua Morris, and Yochai Shavit.
...
* To learn how to write R code with good style--that is, code that's readable and pleasant to look at--please read this brief [guide](http://adv-r.had.co.nz/Style.html).
